<template>
  <div class="quailty-features pt-10 py-13 bg-grey-lighten-3">
    <v-container fluid>
      <v-row>
        <v-col v-for="card in feat" :key="card.nameFeat" class="px-4">
          <div>
            <v-hover v-slot="{ isHovering, props }">
              <v-card
                ...
                :color="isHovering ? 'blue-lighten-3' : 'white'"
              >
                <div class="parent-quialty">
                  <span class="icon-card" v-html="card.icons"></span>
                  <v-card-title
                    style="font-size: 15px; font-weight: 700"
                    class="text-uppercase"
                  >
                    {{ card.nameFeat }}</v-card-title
                  >
    ...
    feat: [
      {
        ...
        nameFeat: "quialty and saving",
        descrip: "comprehensive quailty control and affordable prices",
      },
      {
        ...
        nameFeat: "global warehouse",
        descrip: "37 overseas warehouses",
      },
      {
        ...
        nameFeat: "fast shipping",
        descrip: "fast and convenient door to door delivery",
      },
      {
        ...
        nameFeat: "payment security",
        descrip: "more than 10 different secure payment methods ",
      },
      {
        ...
        nameFeat: "have a questions",
        descrip: "24/7 coustmer services - we're here and happy to help",
      },
    ],
  }),
};
