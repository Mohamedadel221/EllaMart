    ...
    >
      ...
      <v-container fluid>
        <v-row class="align-center">
          ...
          <v-col cols="12" md="5" class="text-center">
            <div class="input-search position-relative">
              ...
              <div
                class="icons-search"
                style="position: absolute; top: 6px; right: 10%"
              >
                <v-icon style="cursor: pointer" class="mrl-1" color="black"
                  >mdi-magnify</v-icon
                >
              </div>
            </div>
          ...
          <v-col cols="12" md="4">
            <div
              class="parent text-white text-capitalize d-flex justify-space-between align-center"
            >
              <div class="available">
                <span class="text-capitalize">available 24 / 7</span>
                <br />
                <strong>(090) 123-4567</strong>
              </div>
              <div class="wishlist d-flex text-orange flex-column align-center">
        ...
        C482,254.358,413.255,312.939,309.193,401.614z"
              ...
              <div class="wishlist text-orange d-flex flex-column align-center">
                <svg
              ...
              <div
                class="wishlist text-orange d-flex flex-column align-center"
                @click="openCart"
        ...
        <v-row class="mt-6">
          ...
          <v-col cols="4" class="d-flex justify-end" style="gap: 35px">
            <div class="help d-flex align-center click-cour" style="gap: 5px">
              <svg
                aria-hidden="true"
                focusable="false"
                data-prefix="fas"
            ...
            <div
              class="lang d-flex align-center click-cour"
              id="Langu"
              style="gap: 5px"
            >
              <svg
...
export default {
  ...
  computed: {
    ...
    ...mapState(cartStore, ["cartItem", "searchResults"]),
  },
  methods: {
    ...mapActions(cartStore, ["searchItem"]),
    openCart() {
